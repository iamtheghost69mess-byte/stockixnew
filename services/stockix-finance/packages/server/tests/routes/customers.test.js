    ...
    it('Should store the customer data to the storage.', async () => {
      const res = await request()
        ...
        .send({
          ...
          company_name: 'Stockix',

          display_name: 'Ahmed Bouhuolia, Stockix',
      ...
      expect(foundCustomer[0].companyName).equals('Stockix');
      expect(foundCustomer[0].displayName).equals('Ahmed Bouhuolia, Stockix');
