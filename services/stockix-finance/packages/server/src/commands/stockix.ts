...
// - stockix system:migrate:latest
// - stockix system:migrate:rollback
// - stockix tenants:migrate:latest
// - stockix tenants:migrate:latest --tenant_id=XXX
// - stockix tenants:migrate:rollback
// - stockix tenants:migrate:rollback --tenant_id=XXX
// - stockix tenants:migrate:make
// - stockix system:migrate:make
// - stockix tenants:list
