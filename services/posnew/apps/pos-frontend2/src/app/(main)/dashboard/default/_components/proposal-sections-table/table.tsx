...
export function ProposalSectionsTable({ data: initialData }: { data: ProposalSectionsRow[] }) {
  ...
  return (
    ...
    >
      ...
      <TabsContent value="outline">{renderDummyTableUi()}</TabsContent>
      <TabsContent value="past-performance">{renderDummyTableUi()}</TabsContent>
      <TabsContent value="key-personnel">{renderDummyTableUi()}</TabsContent>
      <TabsContent value="focus-documents">{renderDummyTableUi()}</TabsContent>
    </Tabs>
  );
}
