-- PMS Phase 1 upgrade: extend existing tables, add new tables

-- pms_properties: operational config fields
...
-- pms_rooms: description, amenities, floor
ALTER TABLE "pms_rooms"
  ADD COLUMN IF NOT EXISTS "description" text,
  ADD COLUMN IF NOT EXISTS "amenities"   text NOT NULL DEFAULT '[]',
  ADD COLUMN IF NOT EXISTS "floor"       integer;

-- pms_guests: identity/compliance fields
...
-- pms_bookings: occupancy counts, platform, check-in actuals, Finance sync
...
-- pms_ical_channels: platform slug, buffer days, failure tracking
...
-- pms_cleaning_tasks: property link, completion tracking, photos
...
-- pms_message_templates: property scope, subject, trigger, send offset
