...
ALTER TABLE "owners" ADD COLUMN "role" text DEFAULT 'super_admin' NOT NULL;
--> statement-breakpoint
ALTER TABLE "owners" ADD COLUMN "mfa_secret" text;
--> statement-breakpoint
ALTER TABLE "owners" ADD COLUMN "mfa_enabled" boolean DEFAULT false NOT NULL;
--> statement-breakpoint
ALTER TABLE "owners" ADD COLUMN "last_login_at" timestamp with time zone;
--> statement-breakpoint
ALTER TABLE "owners" ADD COLUMN "invite_token" text;
--> statement-breakpoint
ALTER TABLE "owners" ADD COLUMN "invite_token_expires_at" timestamp with time zone;
--> statement-breakpoint
ALTER TABLE "owners" ADD COLUMN "invited_by_id" uuid;
--> statement-breakpoint
DO $$ BEGIN
...
END $$;
--> statement-breakpoint
CREATE INDEX "admin_audit_log_actor_created_idx" ON "admin_audit_log" USING btree ("actor_id","created_at");
--> statement-breakpoint
CREATE INDEX "admin_audit_log_tenant_created_idx" ON "admin_audit_log" USING btree ("target_tenant_id","created_at");
--> statement-breakpoint
CREATE INDEX "admin_audit_log_owner_created_idx" ON "admin_audit_log" USING btree ("target_owner_id","created_at");
