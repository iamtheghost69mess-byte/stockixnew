...
export const tenantDeployments = pgTable("tenant_deployments", {
    ...
    uniqueIndex("tenant_deployments_compose_project_name_unique").on(t.composeProjectName),
]);
/**
 ...
 */
export const tenantProvisionEvents = pgTable("tenant_provision_events", {
    id: uuid("id").primaryKey().defaultRandom(),
...
export const tenantLifecycleJobs = pgTable("tenant_lifecycle_jobs", {
    id: uuid("id").primaryKey().defaultRandom(),
